...
<html lang="en">
  ...
  <head>
    ...
    <script src="https://kit.fontawesome.com/28c8108956.js" crossorigin="anonymous"></script>
		<!-- Google fonts
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
			    <a href="TxnTest.php" class="main-filled-button">Donate</a>
    ...
    <footer class="footer py-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-4 text-lg-left">EDUCATION</div>
                    <div class="col-lg-4 my-3 my-lg-0">
                        <div class="right-text-content">
                            <ul class="social-icons">
                                <li><p>Follow Us</p></li>
                                <li><a rel="nofollow" href="https://fb.com/templatemo"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a rel="nofollow" href="https://fb.com/templatemo"><i class="fab fa-twitter"></i></a></li>
                                <li><a rel="nofollow" href="https://fb.com/templatemo"><i class="fab fa-linkedin"></i></a></li>
                                <li><a rel="nofollow" href="https://fb.com/templatemo"><i class="fab fa-dribbble"></i></a></li>
                            </ul>
                    </div>
                    </div>
                    <div class="col-lg-4 text-lg-right">
                        <a class="mr-3" href="#!" style="color:black">Privacy Policy</a>
